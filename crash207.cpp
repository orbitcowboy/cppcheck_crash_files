 ; void ( y ) { int i ; for ( i = 0 ; ; ) }

/*
 Checking crash207.cpp...
...
#1  0x08443344 in isVariableChanged (start=0x8547e58, end=0x8547828, varid=1)
    at lib/valueflow.cpp:260
#2  0x0844a3d0 in valueFlowForLoopSimplify (bodyStart=0x8547e58, varid=1, 
...
#5  0x083fb055 in Tokenizer::tokenize (this=0xbfffe338, code=..., 
    FileName=0x8546f24 "crash207.cpp", configuration=..., noSymbolDB_AST=false)
    at lib/tokenize.cpp:1607
#6  0x0835d8b4 in CppCheck::checkFile (this=0xbfffeb3c, code=..., 
    FileName=0x8546f24 "crash207.cpp") at lib/cppcheck.cpp:355
